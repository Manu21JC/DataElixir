...
class Diffusion(object):
    ...
    def diffuse_t_steps(self, x, t):
        noise = torch.randn_like(x)
        return self.sqrt_alphas_cumprod[t] * x + self.sqrt_one_minus_alphas_cumprod[t] * noise
